                ...
                if (isOneWay == true) {
                    ...
                    function updateChargeableDays() {
                        ...
                        if (selectedDate) {
                            ...
                            var extraDaysAllowedFreeInput = $("#extraDaysAllowedFree");
                            var extraDaysAllowedFree = parseInt(extraDaysAllowedFreeInput.val(), 10) || 0;
                            extraDaysAllowedFree = Math.min(extraDaysAllowedFree, totalDaysDiff);

                            extraDaysAllowedFreeInput.val(extraDaysAllowedFree);
